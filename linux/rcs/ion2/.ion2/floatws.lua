...
floatws_bindings{
    kpress(DEFAULT_MOD.."KP_6",
           function(ws) ws:circulate():raise() end),
    kpress(DEFAULT_MOD.."KP_4",
           function(ws) ws:backcirculate():raise() end),
--    submap(DEFAULT_MOD.."K") { 
--        kpress("AnyModifier+Tab",
--               function(ws) ws:backcirculate():raise() end),
--    },
    kpress(DEFAULT_MOD.."KP_2", function(ws, curr) curr:lower() end),
    kpress(DEFAULT_MOD.."KP_8", function(ws, curr) curr:raise() end),
}
