...
ionws_bindings{
    ...
    kpress(DEFAULT_MOD.."KP_Down", WIonWS.goto_below),
    -- kpress(DEFAULT_MOD.."P", WIonWS.goto_above),
    kpress(DEFAULT_MOD.."KP_Up", WIonWS.goto_above),
    -- kpress(DEFAULT_MOD.."Tab", WIonWS.goto_right),
    kpress(DEFAULT_MOD.."KP_Right", WIonWS.goto_right),
    --submap(DEFAULT_MOD.."K", {
    --    kpress("AnyModifier+Tab", WIonWS.goto_left),
    --}),
    kpress(DEFAULT_MOD.."KP_Left", WIonWS.goto_left),
}
...
--           function(frame) frame:split("top") end),
    kpress(DEFAULT_MOD.."KP_Subtract", function(frame) frame:split("top") end),
    kpress(DEFAULT_MOD.."KP_Divide", function(frame) frame:split("left") end),
