...
global_bindings{
    ...
    kpress(DEFAULT_MOD.."KP_1", WScreen.switch_prev),
    kpress(DEFAULT_MOD.."KP_3", WScreen.switch_next),
    kpress(DEFAULT_MOD.."KP_Decimal", clear_tags),
...
--                                  end
--                              end),
    kpress(DEFAULT_MOD.."F1", make_exec_fn("uxterm -e w3m /home/jiqing/.ion2/help.html")),
    -- F2 is a special key for rename in many applications,
    -- so don't bind it alonely
    kpress(DEFAULT_MOD.."F2", make_exec_fn("uxterm")),
    
    -- even if no frame, F8 can also query to exec something
    -- jiqing, 20090321
    kpress(SECOND_MOD.."F8", querylib.query_exec),
    -- F7 show windowlist
    kpress(SECOND_MOD.."F7", make_menu_fn("windowlist")),
    ...
    mpress("Button3", make_pmenu_fn("windowlist")),
    mpress("Button2", make_pmenu_fn("mainmenu")),
...
--                   make_mplex_clientwin_fn(WClientWin.toggle_fullscreen)),
    kpress(DEFAULT_MOD.."KP_5", make_mplex_clientwin_fn(WClientWin.toggle_fullscreen)),
...
--    kpress(DEFAULT_MOD.."T", make_mplex_sub_fn(WRegion.toggle_tag)),
    ...
    kpress(DEFAULT_MOD.."KP_Multiply", make_mplex_sub_fn(WRegion.toggle_tag)),
    kpress(DEFAULT_MOD.."KP_9", WGenFrame.switch_next),
    kpress(DEFAULT_MOD.."KP_7", WGenFrame.switch_prev),
    kpress(DEFAULT_MOD.."KP_Add", WGenFrame.attach_tagged),
    submap(DEFAULT_MOD.."K", {
